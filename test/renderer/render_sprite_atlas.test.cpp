...
TEST(RenderSpriteAtlas, Basic) {
    FixtureLog log;
    RenderSpriteAtlas atlas({ 63, 112 }, 1);
...
TEST(RenderSpriteAtlas, Size) {
    RenderSpriteAtlas atlas({ 63, 112 }, 1.4);
...
TEST(RenderSpriteAtlas, Updates) {
    RenderSpriteAtlas atlas({ 32, 32 }, 1);
...
TEST(RenderSpriteAtlas, AddRemove) {
    FixtureLog log;
    RenderSpriteAtlas atlas({ 32, 32 }, 1);
...
TEST(RenderSpriteAtlas, RemoveReleasesBinPackRect) {
    FixtureLog log;

    RenderSpriteAtlas atlas({ 36, 36 }, 1);
